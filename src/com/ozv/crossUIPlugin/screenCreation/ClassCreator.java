...
public class ClassCreator {
    ...
    public static void createNewClass(String dir, String packageName, String className, String screenName, String ppp) {
        ...
        path = path.substring(0, path.lastIndexOf('/')) + "/templates/ScreenTemplate";
